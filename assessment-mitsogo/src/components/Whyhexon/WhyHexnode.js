...
import './WhyHexnode.css'; // Import custom CSS file for any specific styles
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
        <g id="icon" transform="translate(-350 -1026)">
          <rect id="bg" width="40" height="40" rx="6" transform="translate(350 1026)" fill="#f8faff"></rect>
    ...
    <section className='d-flex justify-content-center align-items-center ' style={{ background: "#F7F7F7", paddingTop: "80px", paddingBottom: '80px' }}>
      <div className='mainWidth'>
        ...
        <div className='row justify-content-between' style={{position:'relative',zIndex:'1'}}>
          <div className='col-lg-5 d-flex align-items-center mb-5 justify-content-start justify-content-md-center justify-content-sm-center ' style={{height:"320px"}}>
          ...
          <div className='col-lg-5 d-flex align-items-center mb-5 justify-content-end justify-content-md-center justify-content-sm-center  ' style={{height:"320px"}}>
            <div style={{ maxWidth: '450px' }}>
              <div class="card p-3" style={{ height: '280px' }}>
                <div class="card-body">
                  <div class="card-title d-flex  align-items-center">
        ...
        >
          ...
          <div className="line-wrapper">
            <div
              className="line-animation position-absolute"
              style={{
                top: "50%",
                left: "50%",
